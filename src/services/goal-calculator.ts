...
export class GoalCalculator {
  calculateGoals(params: CalculateGoalsParams) {
    const { weight } = params;
    ...
    return {
      callories: proteinGrams * 4 + fatGrams * 9 + carbsGrams * 4,
  ...
  private calculateCalories(params: CalculateGoalsParams): number {
...
export const goalCalculator = new GoalCalculator();
